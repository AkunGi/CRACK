...
for z in range(200):
	...
	ua_v = f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5764.226 Safari/537.36"
	ua_s = f"Mozilla/5.0 (Android; Mobile; rv:114.0) Gecko/114.0 Firefox/114.0"
	ua_o = f"Mozilla/5.0 (Macintosh; Intel Mac OS X 11_13) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5771.215 Safari/537.36"
	ua_r = f"Mozilla/5.0 (Android 9.1; Mobile; rv:113.0) Gecko/113.0 Firefox/113.0"
	ua_d = f"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5834.198 Safari/537.36"
	ua_x = f"Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Ubuntu Chromium/115.0.5821.211 Chrome/115.0.5821.211 Safari/537.36"
	ua = str(rc([ua_d,ua_s]))
...
for xcTeam in range(1000):
	rr = random.randint
	rc = random.choice
	ngentot1 = f"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5764.226 Safari/537.36"
	if ngentot1 in ngentott:pass
	else:ngentott.append(ngentot1)
	ngentot2 = f"Mozilla/5.0 (Linux; Android 10; SM-T505) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.5845.214 Mobile Safari/537.36"
	if ngentot2 in ngentott:pass
	else:ngentott.append(ngentot2)
	ngentot3 = f"Mozilla/5.0 (X11; U; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5759.224 Safari/537.36"
	if ngentot3 in ngentott:pass
	else:ngentott.append(ngentot3)
	ngentot4 = f"Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/115.0.5781.194 Safari/537.36"
